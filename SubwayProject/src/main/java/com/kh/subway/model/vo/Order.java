...
public class Order {
	...
	public Order(String name, String phone, String address, String request, String sandwich, String vegetable,
	...
	public String toString() {
		return "Order [name=" + name + ", phone=" + phone + ", address=" + address + ", request=" + request
